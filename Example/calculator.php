        ...
        <form>
            ...
            ?>
              <tr>
                  ...
                  <td><button type="submit" class="btn btn-primary" name="selected" value="<?=$finance->getId()?>">Check</button></td>
              </tr>
                <?
            }
            ?>
...
if ($selected)
{
    ...
    ?>
    <a href="credit-request.php?financeId=<?=$selected?>&price=<?=$price?>&deposit=<?=$deposit?>" class="btn btn-success">Create Credit Request</a>
    <?
